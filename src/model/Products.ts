...
export class Productdb extends appdb {
  ...
  async addProducts(p_name: String, p_desc: any, p_brand: string, p_price: number, p_qnt: number, cat_id: number, p_hsn_code: number, p_discount: number, p_img: string, ip: string) {
    ...
    try {
      ...
      let data: any = { p_name, p_desc, p_brand, p_price, p_qnt, cat_id, p_hsn_code, p_discount, p_img, };
